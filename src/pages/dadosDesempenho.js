...
class dadosDesempenho extends Component {
		...
		axios
			...
			.then(res => {
				this.setState({
					...
					pccqInicial:res.data.pccqInicial,
					itmInicial:res.data.itmInicial,
					muscularInicial:res.data.muscularInicial,
					vo2Inicial:res.data.vo2Inicial,
					flexInicial:res.data.flexInicial,
					agachamentoInicial:res.data.agachamentoInicial,
					apoioInicial:res.data.apoioInicial,
					abdomenInicial:res.data.abdomenInicial,
					pesoInicial:res.data.pesoInicial,
					imcInicial:res.data.imcInicial,
					bfInicial:res.data.bfInicial,
					loading: false
				})
			})
			.catch(err => {
	...
	handleSubmit = event => {
		...
		const userData = {
			...
			pesoInicial: this.state.pesoInicial,
			imcInicial: this.state.imcInicial,
			bfInicial: this.state.bfInicial
		}
		axios
								...
								<Grid item xs={12}>
									<ButtonGroup
										...
										<Button
											...
											Salvar
											{loadingPost && <CircularProgress size={30} className={classes.progress} />}
										</Button>
										<Button type='reset' onClick={this.handleReset} color='dark'>
											Limpar
										</Button>
